...
with(nox, lines(Year, NOx, type = "l", lty = 2))
...
d_ply(ph2.summary, "State", transform, lines(Year, q0.50, lty = lty), text(2009.1, q0.50[length(q0.50)], unique(State), pos = 4, col = "grey40", cex = 0.8))
